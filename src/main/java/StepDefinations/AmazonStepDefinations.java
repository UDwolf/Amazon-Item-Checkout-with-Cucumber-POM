...
public class AmazonStepDefinations extends TestBase {
	...
	public void header_Image_and_colour_of_the_product_to_validate() throws InterruptedException {
		Thread.sleep(1000);
		ProductPage.ValidateProductDetails(productName, "Black", TestBaseUtill.BLACK_PRODUCT_IMG, "true");
	}
	...
	public void product_name_and_Image_should_change_accordingly_and_product_colour_should_change_according_to_new_product_selection() throws InterruptedException {
		ProductPage.changingOfColourAndImage();
	}
